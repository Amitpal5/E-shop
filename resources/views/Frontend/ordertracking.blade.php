...
<div class="container" style="padding:50px;">
    <article class="card">
        ...
        <div class="card-body">
            ...
            <article class="card">
                <div class="card-body row">
			     ...
			     <div class="col"> <strong>Status:</strong> <br> Picked by courier</div>
	 ...
	 @endif
                    <div class="col"> <strong>Tracking #:</strong> <br> {{$check->order_id}}</div>
                </div>
            </article>
            <div class="track">
            	@if($check->status == 0)
                ...
                @elseif($check->status == 1)
                <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pending</span> </div>
                ...
                <li class="col-md-4">
                    <figure class="itemside mb-3">
                        ...
                        <figcaption class="info align-self-center">
                            <p class="title">{{$data->product_Name}}<br> {{$data->Qty}}</p> <span class="text-muted">{{$data->Totla_price}} TK</span>
                        </figcaption>
                    </figure>
                </li>
                @endforeach
