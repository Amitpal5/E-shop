		...
		<section class="checkout-area" style="padding:50px;">
            <div class="container">
                       ...
                       <div class="col-lg-6 sticky-sidebar-wrapper" style="margin-bottom: 50px;">
                       	  <form action="{{route('paymnet.rocket')}}" method="post" id="payment-form">
                            @csrf
              ...
              <td>{{$dis=(double)Cart::subtotal()
                * (int)Session()->get('coupon')['Amount'] /100 }} TK</td>
                ...
                @endif
                          ...
                          <tr class="summary-total">
                          <td class="pb-0">
                            <h4 class="summary-subtitle">Rocket Charge</h4>
                          </td>
                          <td class=" pt-0 pb-0">
                            <p class="summary-total-price ls-s text-primary" id="total">{{$ltotal * 0.016}} TK</p>
                            @php
                             
                             $charges=$ltotal * 0.016;
                        ...
                        <tr class="summary-total">
                          ...
                          <td class=" pt-0 pb-0">
                            <p class="summary-total-price ls-s text-primary" id="total">{{Cart::subtotal() * 0.016}} TK</p>
                            @php
                             
                             $charges=Cart::subtotal() * 0.016;
               ...
               <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="017125328640" disabled>
                                            @php
                                            
                                           $charge=Cart::subtotal()*0.016;
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="payment_no" value="" placeholder="Your Rocket Account No" data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
