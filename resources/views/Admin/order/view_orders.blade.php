      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <!-- /.card -->
            <a href="/admin/accept/{{$orders->id}}" class="btn btn-success btn-block mt-2">Accept Order</a>
		<a href="/cancel/{{$orders->id}}" class="btn btn-danger btn-block mb-4">Cancel Order</a>
          </div>
        </div>
        <!-- /.row -->
