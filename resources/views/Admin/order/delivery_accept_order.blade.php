      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="col-sm-8 p-3">
            <h4>Admin Deliver Hand Over Order List</h4>
            </div>
         ...
         <td>{{$data->subtotal}} TK</td>
           <td>@if($data->status	== 0)
			...
			@endif</td>
                ...
                <td>
    <a href="{{route('admin.deliveryman.accept',['id'=>$data->id,'order_id' =>$data->order_id])}}"><i class="fa fa-edit" style="font-size:25px;"></i></a>
